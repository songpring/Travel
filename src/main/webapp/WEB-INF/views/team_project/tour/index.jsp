...
<!-- 항공권 검색 박스 -->								
		...
		<div id="colorlib-blog">
			<div class="container">
				...
				<div class="blog-flex">
					<div class="f-entry-img" style="background-image: url(https://images.pexels.com/photos/1267694/pexels-photo-1267694.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);">
					</div>
										...
										<c:choose>
											<c:when test="${bean.profile eq null }">
												<c:if test="${bean.gender eq '02' }">
													<span><img src="resources/upload/profile/female.jpg" alt="Avatar" style="width:100px; border-radius: 50%;"></span>
												</c:if>
												<c:if test="${bean.gender eq '01' }">
													<span><img src="resources/upload/profile/male.jpg" alt="Avatar" style="width:100px; border-radius: 50%;"></span>	
												</c:if>
											</c:when>
											<c:otherwise>
												<span><img src="resources/upload/profile/${bean.profile }" alt="Avatar" style="width:100px; border-radius: 50%;"></span>
											</c:otherwise>
										</c:choose>	
						...
						<div class="intro-desc">
							<div class="text-salebox">
								...
								<div class="text-rights">
									...
									<p><a href="together" class="btn btn-primary">동행찾기</a> <a href="together" class="btn btn-primary btn-outline">더읽기</a></p>
								</div>
							</div>
						</div>
					</div>
								...
								<a href="/myapp/honeycontent?seq=${bean.seq }">
									<div class="item">
										<div class="testimony text-center">
											<c:if test="${bean.file_use eq 'N' }">
												<span class="img-user" style="background-image:url(resources/upload/empty.PNG); width: 300px;"></span>
											</c:if>
											<c:if test="${bean.file_use eq 'Y' }">
												<span class="img-user" style=" width: 300px;">${bean.thumb }</span>
											</c:if>
							...
							<div class="row row-pb-md">
								<div class="col-md-6">
									...
									<c:set var="bean" value="${galleryList.get(i) }" />
										<div class="col-md-6 animate-box">
											<a href='<c:url value="galleryId?board_id=gallery&regi_id=${bean.regi_id }"/>'><span class="f-tour-img" style="background-image: url(resources/upload/${bean.path1});">
												<div class="desc">
													<div class="desc">
