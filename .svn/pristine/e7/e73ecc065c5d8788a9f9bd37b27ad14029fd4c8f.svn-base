                  ...
                  <table style="margin: 0 auto;">
                     <tr>
                        <td>
                           ...
                           <form action='<c:url value="/togetherUpdate?seq=${bb1.seq}"/>' method="post">
                              <table class="table">
                                 <tbody>
                                    <tr>
                                 <th scope="row">나라</th>
                              ...
                              <tr>
                               ...
                               <tr>
                                  <th scope="row">제목</th>
                                  <td colspan="5" width=""><input type="text" name="subject" required="required" value="${bb1.subject}" ></td>
                               </tr>
                               <tr>
                                 <td colspan="6">
                                    <textarea id="summernote" name="content" style="width: 70%">${bb1.content }</textarea>
                                 </td>
                               </tr>
                                 </tbody>
                              </table>
